# Contributing to KumuluzEE gRPC

♥ [KumuluzEE gRPC](https://github.com/kumuluz/kumuluzee-grpc) and want to get involved?
...
**[File a bug report](https://github.com/kumuluz/kumuluzee-grpc/issues/)**
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/kumuluzee-grpc.git
   # Navigate to the newly cloned directory
   cd kumuluzee-grpc
   # Assigns the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kumuluz/kumuluzee-grpc.git
   ```
