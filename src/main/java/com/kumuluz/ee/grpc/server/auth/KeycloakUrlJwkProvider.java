...
public class KeycloakUrlJwkProvider implements JwkProvider {
   ...
   */
  public KeycloakUrlJwkProvider(URL url) {
   ...
   */
  public KeycloakUrlJwkProvider(URL url, Integer connectTimeout, Integer readTimeout, Proxy proxy) {
   ...
   */
  public KeycloakUrlJwkProvider(URL url, Integer connectTimeout, Integer readTimeout, Proxy proxy, Map<String, String> headers) {
   ...
   * @param readTimeout    read timeout in milliseconds (null for default)
   */
  public KeycloakUrlJwkProvider(URL url, Integer connectTimeout, Integer readTimeout) {
   ...
   * <br><br> Use {@link #KeycloakUrlJwkProvider(URL)} if you need to pass a full URL.
   *
   * @param domain where jwks is published
   */
  public KeycloakUrlJwkProvider(String domain) {
